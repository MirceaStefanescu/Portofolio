...
public class OrderController {
	...
	public OrderResponse createOrder(@Valid @RequestBody CreateOrderRequest request, Authentication authentication) {
		return orderService.createOrder(requireUser(authentication), request);
	}

	@GetMapping
	public List<OrderResponse> listOrders(Authentication authentication) {
		return orderService.listOrders(requireUser(authentication));
	}
	...
	public OrderResponse confirmPayment(
		...
		return orderService.confirmPayment(requireUser(authentication), orderId, request.paymentIntentId());
	}
